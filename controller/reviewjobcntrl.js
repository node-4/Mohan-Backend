const reviewService = require('../Services/reviewjobservice');
...
exports.getJobsReviews = async (req, res, next) => {
    try{
        const result = await reviewService.getJobsReviews(req.params.jobId);
