const reviewService = require('../Services/reviewmachineservice');
...
exports.getMachinesReviews = async (req, res, next) => {
    try{
        const result = await reviewService.getMachinesReviews(req.params.machineId);
